...
void register_plugin_nacl() {
	...
	Super_stack::inet().create(VLAN_manager::get(index_vlan1).add(hw::Devices::nic(index_vlan1), 2), index_vlan1, 2);
	auto& vlan1 = Super_stack::get(index_vlan1, 2);
	...
	Super_stack::inet().create(VLAN_manager::get(index_vlan2).add(hw::Devices::nic(index_vlan2), 2), index_vlan2, 2);
	auto& vlan2 = Super_stack::get(index_vlan2, 2);
	vlan2.network_config(IP4::addr{10,100,1,50}, IP4::addr{255,255,255,0}, 0);
	auto& eth1 = Super_stack::get("c0:01:0a:00:00:2d");
	eth1.network_config(IP4::addr{10,0,0,41}, IP4::addr{255,255,255,0}, 0);
	auto& eth0 = Super_stack::get("c0:01:0a:00:00:1c");
